...
<head>
    ...
    <title>Smart Neighborhood - Official Page</title>
    <!-- Fonts -->
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Arimo:wght@400;700&display=swap" rel="stylesheet">
    <!-- Styles -->
    <link rel="stylesheet" href="{{ asset('css/official-page.css') }}">
</head>
<body>
    <div class="dashboard-container">
        ...
        <main class="main-content">
            ...
            <div class="welcome-banner">
                <div class="welcome-content">
                    <div class="welcome-badges">
                        ...
                        <span class="welcome-badge">official</span>
                    </div>
                    <h1 class="welcome-title">Smart Neighborhood System</h1>
                    <p class="welcome-description">Monitor, manage, and optimize neighborhood maintenance operations</p>
                    <div class="welcome-actions">
                        <a href="/dashboard/official" class="welcome-button primary">
            ...
            <!-- Onboarding Message for New Officials -->
            <div id="onboarding-message" class="onboarding-message" style="display: none;">
                <div class="onboarding-content">
                    ...
                    <div class="onboarding-text">
                        ...
                        <p>Get started by viewing and managing maintenance requests. Monitor all neighborhood activities and keep everything running smoothly.</p>
                    </div>
    ...
    <!-- Scripts -->
    <script src="{{ asset('js/official-page.js') }}"></script>
</body>
</html>
